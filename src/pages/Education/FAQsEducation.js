...
export default () => {
    ...
    const faqsList = [
        ...
        },
        {
            ...
            a: "يمكن للطلاب التسجيل في التخصص الذي يريدونه طوال السنة الدراسية عبر المنصة.  - كما للطالب تحسين المستوى التسجيل في احدى التخصصات المتاحة في المنصة طيلة السنة الدراسية المعلنة عبر المنصة"
        },
        {
