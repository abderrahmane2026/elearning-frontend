...
export default () => {
    ...
    const faqsList = [
        ...
        },
        {
            ...
            a:"	يمكن لطالبي تحسين المستوى التسجيل في التخصص الذي يريدونه طيلة السنة الدراسية المعنية عبر المنصة 	كما لطالبي تحسين المستوى التسجيل في احدى التخصصات المتاحة في المنصة طيلة السنة الدراسية المعنية عبر المنصة"
        },
        {
        ...
        },
        {
            ...
            a:"	تقدم المنصة دروس ومواد للتعلم في العديد من النصوص، الصور والفيديوهات المسجلة مع خبراء المادة وشرحها بطريقة مبسطة وسهلة	مع إمكانية عرضها في ملقات صوتية ومقروءة مثل PDF و ال Powerpoint "
        },
        {
            q: "ما هي الخطوات المطلوبة لأنشاء صف افتراضي على منصة طور نفسك؟",
            a: "يمكنك الدخول الى اللوح التعليمية والضغط على الواجهة الخاصة بتسجيل دروس المعلم من أجل إضافة الصفوف  الافتراضية الجديدة "
        }
