    ...
    const features = [
        {
            ...
            "desc": "، سواء كانوا تابعين  للمدارس العليا أو الجامعات."
        },
        {
            "title": "المؤسسات العمومية التابعة لوزارة التعليم العالي",
            "desc": "، التكوين المهني، ووزارة التربية والتعليم، من خلال عقد اتفاقيات شراكة."
        },
        {
        ...
        <section>
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 xl:flex">
                <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
                    ...
                    منصة الكترونية تشجع التعلم المستمر وتطوير المهارات بطريقة سهلة ومرنة وبأسعار مناسبة.
                    <br/>
تقدم خدمات تعليمية رقمية مخصصة لتحسين مستوى الموظفين من طرف أساتذة دائمين، متقاعدين ذوي خبرات وكفاءات، يعملون بساعات اضافية مع الحصول على شهادة، 
<br/>
توفر للمتربص والمتمهن ضمان الحصول على التربص وهم يزاولون دراستهم ومساعدتهم نحو تحقيق أهدافهم وبناء مستقبلهم وذلك بتقديم طلب التوظيف.
<br/>

تقديم محتوى تعليمي غني ومتميز من خلال دورات تعليمية مجانية أو مدفوعة عبر المنصة تغطي مجموعة متنوعة من المجالات العلمية والمهنية.
<br/>
تساعد على اكتساب المعرفة، المهارات والخبرات وتطوير قدرات من طرف أفضل الأساتذة المتخصصين، خبراء، مكونين، ومدربين في مختلف المجالات والتخصصات وباحترافية عالية. 
