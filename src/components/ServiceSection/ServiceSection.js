...
export default function ServiceSection() {
    const features = [
        ...
        },
        {
            ...
            title: "توفير التكوين",
            desc: "توفير تكوينات تتناسب مع احتياجات طالبي التكوين الذين يرغبون في تطوير مهاراتهم أو تلبية احتياجاتهم المهنية بما يتطلبه سوق العمل الجزائري من أجل الحصول على وظيفة..... أصحاب المؤسسات الناشئة هم الأمل والركيزة الحقيقية لاقتصاد المعرفة في الجزائر، لذلك وجب إعادة دعمهم ودفعهم من جديد من أجل تجديد ثقتهم وايمانهم بالنجاح وذلك من خلال تكوينات في مجالات عديدة تعيد تأهيلهم من جديد لمعالجة النقائص ومواجهة التحديات التي تعرقل ابتكارهم وتقف أمام تطور مؤسساتهم.",
        },
        {
            icon: 
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            title: "تحسين المستوى",
            desc: " المنصة تجمع في مكان واحد الأساتذة والخبراء والمتخصصين في مختلف التخصصات للاستفادة من خبراتهم سواء كان ذلك بغرض التكوين أو تحسين المستوى الدراسي.توفير إمكانية تحسين المستوى عن بعد للموظفين في جميع القطاعات العمومية والاقتصادية. و التكوين للجميع عن بعد لكل مستخدمي الإنترنت.توفير إمكانية التواصل الفوري والمباشر مع الأساتذة والمكونين عبر التعليقات أثناء البث المباشر أو التواصل غير التزامني عبر التعليقات على الفيديوهات المسجلة أو الهاتف أو الماسنجر أو الايميل، دون عناء وجهد التنقل أو السفر أو تضييع الوقت في المواصلات",
        },
        {
            icon: 
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        },
        {
            ...
            desc: " إعطاء شهادة تكوين أو تحسين المستوى معترف بها من طرف وزارة التعليم العالي والبحث العلمي، أو من طرف وزارة التعليم والتربية.- إعطاء شهادات معتمدة في مختلف المجالات والتخصصات",
        },
    ]
