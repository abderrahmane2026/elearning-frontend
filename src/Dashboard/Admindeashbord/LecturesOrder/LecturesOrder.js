...
import './LecturesOrder.css';

const LecturesOrders = () => {
  ...
  useEffect(() => {
    const fetchCourseOrders = async () => {
      try {
        const response = await axios.get('https://develop-yourself.onrender.com/api/order/Lectures-orders');
